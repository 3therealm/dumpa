...
_DEFAULT_SPECS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec('radare2', ('radare2', 'r2'), required=False, version_argv=('-v',),
             install_hint='radare2 (optional); deeper native region scanning'),
    ToolSpec('jadx', ('jadx',), required=False, version_argv=('--version',),
             install_hint='JADX (optional); Java/Kotlin decompilation'),
    ToolSpec('baksmali', ('baksmali',), required=False,
             install_hint='baksmali (optional); low-level DEX inspection'),
    ToolSpec('adb', ('adb',), required=False, version_argv=('version',),
             install_hint='Android platform-tools (optional); dynamic analysis'),
